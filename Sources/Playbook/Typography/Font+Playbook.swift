...
public enum PBTextStyle: Equatable {
    ...
    case title4
    case body
    case buttonText(_ size: PBButtonSize? = .medium)
    case largeCaption
    case caption
    case subcaption
    ...
    var font: Font {
        ...
        case .buttonText(let size):     return Font.custom(ProximaNova.bold.rawValue, size: size?.fontSize() ?? 14, relativeTo: .body)
        case .largeCaption:   			return Font.custom(ProximaNova.regular.rawValue, size: 14, relativeTo: .caption)
